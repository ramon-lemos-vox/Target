...
const diasUteis = dadosFaturamento.filter(item => item.valor > 0).map(item => item.valor);
...
const diasAcimaMedia = diasUteis.filter(valor => valor > media).length;

console.log("Menor faturamento:", menor);
console.log("Maior faturamento:", maior);
console.log("Média dos faturamentos dos dias úteis:", media);
